...
names = [
    ...
    "AMAN", "AMAN SONY", "ANDREW JUDAH", "ANDREW SHELTON S",
    "ANGEL SHIBU", "ANNIKA DUBEY", "ANSON NORONHA", "ANTONY OUSEPPACHAN", "ARUSH CHANDRA",
    "ARYANANDA BIJU", "BABITHA RAVINDRA", "CHRIS SAMUEL", "DEVYANSH SINGH",
    "DHAIRYA BARBHAYA", "DHAYAA V", "ETHAN THOMAS MATHEW", "GAURAV SINGH ADHIKARI",
    "HIMANSHI KANSAL", "ISHAAN KATARIA", "JESHAL MATHIAS", "JUSTIN T SHIJOY",
    "KUSHAL K", "LEO DSOUZA S", "LIDIA ARUL", "MARIA RACHEL MANOJ",
    "MARVIN ROPMUANG", "MEET GARG"
]
