...
def main():
    ...
    tab1, tab2, tab3, tab4, tab5, tab6, tab7, tab8, tab9 = st.tabs([
        ...
        "Challenges and Future Trends", "Case Studies & Best Practices", "Wrap-Up & Q&A"
    ])
    ...
    with tab3:
        ...
        st.markdown("**Your Challenge:** Form teams and create a concept for an IoT-powered system that detects genetic diseases.")
